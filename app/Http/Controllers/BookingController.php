...
class BookingController extends Controller
{
    ...
    public function decline(Request $request, int $id)
    {
        ...
        // Single decline notification. (Merge note: both Amer's decline-refund
        // fix and Mohamad's booking-event wiring added a decline notification;
        // kept as ONE to avoid double-notifying the customer.)
