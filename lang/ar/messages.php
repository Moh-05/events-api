...
return [
    ...
    'notif_new_booking_title'      => 'حجز جديد مدفوع',
    'notif_new_booking_body'       => 'لديك حجز جديد مدفوع رقم :id. يرجى القبول أو الرفض',
    'notif_approved_title'         => 'تم قبول الحجز',
    'notif_approved_body'          => 'تمت الموافقة على حجزك رقم :id من قبل المزوّد',
    'notif_completed_title'        => 'اكتملت الخدمة',
    'notif_completed_body'         => 'اكتمل حجزك رقم :id. لا تنسَ ترك تقييم!',
    'notif_declined_title'         => 'تم رفض الحجز',
    'notif_declined_body'          => 'تم رفض حجزك رقم :id. سيتم إعادة مبلغك',
    'notif_review_title'           => 'تقييم جديد',
    'notif_review_body'            => 'حصلت على تقييم بـ :rating نجوم',
    'notif_cancelled_title'        => 'تم إلغاء الحجز',
    'notif_cancelled_body'         => 'قام العميل بإلغاء الحجز رقم :id',
